...
public class OnlCgreportItemController {
    ...
    public Result queryPageList(OnlCgreportItem onlCgreportItem, @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo, @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize, HttpServletRequest req) {
    ...
    public Result queryById(@RequestParam(name = "id", required = true) String id) {
        ...
        if (onlCgreportItem == null) {
            ...
            return ResultUtils.okData(onlCgreportItem);
