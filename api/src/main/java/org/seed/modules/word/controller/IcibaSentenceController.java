...
public class IcibaSentenceController {
    ...
    public Result queryPageList(IcibaSentence icibaSentence,
    ...
    public Result add(@RequestBody IcibaSentence icibaSentence) {
        try {
    ...
    public Result edit(@RequestBody IcibaSentence icibaSentence) {
    ...
    public Result queryById(@RequestParam(name = "id", required = true) String id) {
        ...
        if (icibaSentence == null) {
            ...
            return ResultUtils.okData(icibaSentence);
    ...
    public Result importExcel(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
            ...
            try {
                ...
                return ResultUtils.ok("文件导入成功！数据行数：" + listIcibaSentences.size());
            } catch (Exception e) {
