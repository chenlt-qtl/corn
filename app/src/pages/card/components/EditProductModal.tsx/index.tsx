            ...
            >
                ...
                >
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: "5px" }}>
                        {[...Array(7).keys()].map(i => <div style={{ textAlign: "center" }}>
                            <img style={{ width: "40px", display: "block" }} key={i} src={`/img/sm/${i}.svg`}></img>
                            {i}
                        </div>)}
                    </div>
                    <span style={{color:"#777"}}>格式 ：名称,价格,[图片编号]</span>
                    {tabs.map((tab, index) => <Form.Item
                        label={tab}
                        name={index}
