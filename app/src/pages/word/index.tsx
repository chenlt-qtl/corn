...
import { SearchOutlined, ContainerOutlined, ReadOutlined, ExperimentOutlined } from '@ant-design/icons';
    ...
    const render = function () {
        ...
        return (
            <div className={styles.wi_container}>
                ...
                <div className={styles.wi_searchBar}>
                    <Input
                        size="large"
                        placeholder="Search..."
                        prefix={<SearchOutlined className="site-form-item-icon"/>}
                        value={searchStr} onChange={e=>setSearchStr(e.target.value)} onPressEnter={onSearch}
                    
                    />
                    {wordName ? <WordDetail wordName={wordName} articleId="0"></WordDetail> : ""}
                </div>
