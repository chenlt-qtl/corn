...
const Mp3Time: React.FC = (props) => {
    ...
    return (
        <div className={styles.mp3Time} ref={container}>
            <InputNumber value={startTime} onFocus={() => onFocus("start")}></InputNumber >
            <div className={styles.hyphen} />
            <InputNumber value={endTime} onFocus={() => onFocus("end")}></InputNumber >
            ...
            <div className={styles.adjust} style={{ height: height + "px", left: left + "px" }}>
                <div className={styles.content}>
                    <Button type="link" onClick={() => changeTime(1)}>+1s</Button>
                    <Button type="link" onClick={() => changeTime(5)}>+5s</Button>
                    <Button type="link" onClick={() => changeTime(-1)} danger>-1s</Button>
                    <Button type="link" onClick={() => changeTime(-5)} danger>-5s</Button>
                </div>
            </div>
        </div>
    );
